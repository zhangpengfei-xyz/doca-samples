...
#define VFIO_ADMINQ_UAR_BASE_OFFSET 0x10000U
#define VFIO_ADMINQ_UAR_REGION_SIZE 0x10000U
#define VFIO_ADMINQ_UAR_REGION_COUNT 3U
#define VFIO_ADMINQ_UAR_PAGE_SIZE 0x1000U
#define VFIO_ADMINQ_UAR_MAX_ID 47U
#define VFIO_ADMINQ_NUM_MSIX 129U

/* Compatibility aliases used by the v1 host emulator until it is retired. */
...
#define VFIO_ADMINQ_DB_REGION_OFFSET 0U
#define VFIO_ADMINQ_DB_REGION_SIZE 0U
#define VFIO_ADMINQ_DB_LOG_SIZE 0U
#define VFIO_ADMINQ_DB_STRIDE_LOG_SIZE 0U
#define VFIO_ADMINQ_DB_COUNT 0U
...
#define SRDMA_UAR_AEQ_DB 0x004U
