 ...
 * region. AdminQ/AEQ carry PI/CI; CEQ/CQ/SQ/RQ carry their resource handle.
...
#define VFIO_ADMINQ_DB_COUNT 33U
#define SRDMA_DB_TYPE_COUNT 6U

enum srdma_doorbell_id {
    SRDMA_DB_ADMINQ = 0,
    SRDMA_DB_AEQ = 1,
    SRDMA_DB_CEQ = 2,
    SRDMA_DB_CQ = 3,
...
#define SRDMA_DB_HW_ADMINQ (SRDMA_UAR_ADMINQ_DB >> VFIO_ADMINQ_DB_STRIDE_LOG_SIZE)
#define SRDMA_DB_HW_AEQ (SRDMA_UAR_AEQ_DB >> VFIO_ADMINQ_DB_STRIDE_LOG_SIZE)
#define SRDMA_DB_HW_CEQ (SRDMA_UAR_CEQ_DB >> VFIO_ADMINQ_DB_STRIDE_LOG_SIZE)
#define SRDMA_DB_HW_CQ (SRDMA_UAR_CQ_DB >> VFIO_ADMINQ_DB_STRIDE_LOG_SIZE)
#define SRDMA_DB_HW_RQ (SRDMA_UAR_RQ_DB >> VFIO_ADMINQ_DB_STRIDE_LOG_SIZE)
#define SRDMA_DB_HW_SQ (SRDMA_UAR_SQ_DB >> VFIO_ADMINQ_DB_STRIDE_LOG_SIZE)

#define VFIO_ADMINQ_DB_ID SRDMA_DB_ADMINQ
#define SRDMA_DB_VALUE_MASK UINT32_C(0xffff)
...
#define SRDMA_UAR_ADMINQ_DB 0x000U
#define SRDMA_UAR_AEQ_DB 0x008U
#define SRDMA_UAR_CEQ_DB 0x040U
#define SRDMA_UAR_CQ_DB 0x080U
#define SRDMA_UAR_RQ_DB 0x0c0U
#define SRDMA_UAR_SQ_DB 0x100U
#define SRDMA_BAR0_DOORBELL_OFFSET SRDMA_UAR_ADMINQ_DB

#define SRDMA_ADMINQ_DEPTH 128U
#define SRDMA_ADMINQ_ENTRY_SIZE 128U
#define SRDMA_AEQ_DEPTH 4096U
#define SRDMA_AEQ_ENTRY_SIZE 8U
